    ...
    return (
        <>
            ...
            <div className="mx-auto flex w-80 flex-col items-center gap-2">
                <button
                    className="mx-auto flex w-full items-center justify-center gap-3 rounded-3xl bg-white px-4 py-2.5 font-bold text-black transition-colors duration-300 hover:bg-white/80"
