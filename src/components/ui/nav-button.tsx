...
const link = tv({
    base: 'flex flex-1 flex-col items-center gap-1 text-xs md:w-full md:flex-row md:gap-3 md:rounded-xl md:px-6 md:py-2.5 md:text-base md:hover:bg-hover [&:nth-child(n+6)]:hidden md:[&:nth-child(n+6)]:flex',
    variants: {
        active: {
